...
import static com.github.upcraftlp.worldinfo.WorldInfo.MODID;
import static com.github.upcraftlp.worldinfo.WorldInfo.MOD_NAME;

@Listener
@Mod(id = MODID, name = MOD_NAME, authors = {"UpcraftLP", "HyperSpeeed"}, version = "@VERSION@")
